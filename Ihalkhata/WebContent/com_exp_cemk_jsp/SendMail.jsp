...
<%@ page import="com.exp.cemk.util.SessionUtil"%><%@ page import="domainmodel.Person"%><%
  ...
  <body>
    ...
    <script type="text/javascript" src="../com_exp_cemk_js/sendMail.js"></script>
	
	
    <div id="viewEmailcontent" style="margin-left: 5%;margin-right: 5%;"></div>
    <form>
