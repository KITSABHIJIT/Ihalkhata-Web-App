...
private static final Logger logger = Logger.getLogger(GridExpenditureProcessor.class);
	...
	public JSONObject getGridExpenditureData(int start,int limit,String month,String year,String endmonth,String endYear,String type, int groupId) {
	...
	public JSONObject getSelectedExpenditureGrid(int start,int limit,String month,String year,String endmonth,String endYear,String type, int groupId) {
		int reccnt = 0;
		//Connection con = null;
		//Statement stmt = null;
		//ResultSet rs = null;
		...
		try {
			...
			for(int i=0;i<expenditureList.size();i++){
				...
				jsonItems.put("amount",CommonUtil.getRoundedValue(expenditureList.get(i).getAmount()));
					reccnt = reccnt + 1;
	...
	public JSONArray getGridPieExpenditureData(String month,String year,String endmonth,String endYear,String type,int groupId){
...
public JSONArray getExpenditureData(String month,String year,String endmonth,String endYear,String type,int groupId,String userName){
	...
	logger.info("Controller-->getExpenditureData-->Spring Data Access-->getExpenditureData");
		try {
			...
			for(int i=0;i<expenditureList.size();i++){
				...
				JSONObject jsonItems=new JSONObject();
				jsonItems.put("amount",CommonUtil.getRoundedValue(expenditureList.get(i).getAmount()).toString());
				arrayObj.add(jsonItems);
				}
				}
