...
public class DataEntryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Boolean check=insertData(shareHolders, date, itemlist, giver, totalExp, shareHolderCount,perHead,desc,groupId);
		...
		private Boolean insertData(String shareholders,String date,String items,String giver,String price,String count,String perHead,String desc,int groupId) {
		Boolean flag=false;
