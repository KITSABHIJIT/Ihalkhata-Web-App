...
Ext.ux.form.LovCombo = Ext.extend(Ext.form.ComboBox, {
	...
	,getCheckedDisplay:function() {
		...
		//alert("getCheckedDisplay = "+this.getCheckedValue(this.displayField));
	...
	,getCheckedValue:function(field) {
		...
		//return c;  //return c.join(this.separator);  ***** ---- done
	...
	,onRealBlur:function() {
		...
		//alert("this.getRawvalue () in onRealBlur = "+this.getRawValue());
	...
	//	//alert("onSelect = "+this.getCheckedValue());
        if(this.fireEvent('beforeselect', this, record, index) !== false){
			...
			//alert("this.setValue(this.getCheckedValue()) = "+this.getCheckedValue());
	 ...
	 */
	,setValue:function(v) {
	//	alert("this.valueField = "+(this.valueField)); //exchToken
		if(v) {
			v = '' + v;
			if(this.valueField) {
				this.store.clearFilter();
				...
				//alert("this.value = this.getCheckedValue() = "+this.getCheckedValue()); // 1
				this.value = this.getCheckedValue();
			//	alert("this.setRawValue(this.getCheckedDisplay()); = "+this.getCheckedDisplay());  //NSE
				this.setRawValue(this.getCheckedDisplay());
			//	this.setRawValue(this.getCheckedValue());
