...
<center><table cellpadding="0" cellspacing="0" height="100%" border="0">
	...
	<tr>
		<td height="50%" style="vertical-align: bottom;"><p style="font-size:200px;">Split4Us</p></td>
	</tr>
	<tr>
		<td height="10%" style="vertical-align: top; text-align: center;">
		<a href="javascript:loginPopup()" title="Start Split4Us"><img alt="Start Split4Us" src="../com_exp_cemk_css/images/start1.png"></a>
		</td>
	</tr>
	<tr>
		<td height="40%" style="vertical-align: bottom;">
			<div align="center"><p>Copyright &copy; 2013. Design by <a href="" title="Split4Us Web Developers">Split4Us Web Developers</a></p></div>
		</td>
	</tr>
</table></center>
</body>
