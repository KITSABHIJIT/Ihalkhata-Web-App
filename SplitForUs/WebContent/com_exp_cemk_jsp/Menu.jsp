...
<body>
	...
	<div id="loading">
		<div class="loading-indicator"><br/>Ihalkhata Loading...</div>
	</div>
	<div class="dock" id="dock">
		<div class="dock-container">
			<a class="dock-item" href="Home.jsp" rel="balloon"><img
				...
				class="dock-item" href="<%=uriPrefix%>/LogoffServlet"><img
	...
	<table border="0" id="balloon" class="balloonstyle"
		...
		<tr>
			<td><img
				...
				alt="Welcome <%=userName%>" height="60" width="60" />
			</td>
			<td>
				<table>
		...
		<tr><td colspan="2"><b>Last Login Time:-<br/><%=logontime%></b></td></tr>
	</table>
	<!-- Feedback form -->
	<div class="feedback">
		...
		<div class="form">
			...
			<div id='loadingmessage' style="text-align:center; position:absolute; top:0; left:0; width:100%; color:blue; display: none">
				<img src='../com_exp_cemk_extjs_js/feedback/loading_image.gif' width="150px" height="150px"/>
			</div>
			<textarea id="feedback_text" onkeyup="limiter(200,'feedback_text','limit','html')"></textarea>
			<script type="text/javascript">
				document.write("<div id='limit' style='width:300px;text-align:right;'><font color='blue'><i>200 Characters left</i></font></div>");
			</script>
...
<!-- twitter follow badge -->
		<script src=' ../com_exp_cemk_feeds/tripleflap.js';' type='text/javascript'></script><script type='text/javascript' charset='utf-8'>
		<!--
