...
<title>View Monthly Individual Expenditure</title>
...
%>
	...
	<script type="text/javascript"	src="../com_exp_cemk_js/ViewIndividuals.js"></script>
	
	<div id="viewIndividualcontent" style="margin-left: 5%;margin-right: 5%;"></div>
	<%}%>
</body>
</html>
